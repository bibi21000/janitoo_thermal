...
janitoo_entry_points = {
    "janitoo.threads": [
        "thermal = janitoo_thermal.thread_thermal:make_thread",
    ],
    "janitoo.components": [
        ...
        "thermal.external_heater = janitoo_thermal.thermal:make_external_heater",
    ],
}

setup(
    name = 'janitoo_thermal',
    description = "Thermal tools for janitoo",
    long_description = "Thermal tools for janitoo",
    ...
    zip_safe = False,
    scripts=['src/scripts/jnt_thermal'],
