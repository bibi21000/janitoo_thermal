...
class TestThermalThread(JNTTThreadRun, JNTTThreadRunCommon):
    ...
    def test_101_values_config(self):
        ...
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('thermal_sensor0'))
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('thermal_heater0'))
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('thermal_simple0'))
        ...
        self.assertEqual(1, self.thread.bus.nodeman.find_value('thermal_sensor0','users_read').get_length())
        value = self.thread.bus.nodeman.find_value('thermal_sensor0','users_read')
        ...
        self.assertEqual(1, self.thread.bus.nodeman.find_value('thermal_heater0','users_write').get_length())
        value = self.thread.bus.nodeman.find_value('thermal_heater0','users_write')
        print value.get_value_config()
